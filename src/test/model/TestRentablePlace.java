...
public class TestRentablePlace {
	...
	public RentablePlace setup() {
		...
		RentablePlace rentablePlace = new Hotel("nome", "indirizzo", "citta", "Proprietario");
		...
		room1.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 1, 6), LocalDate.of(2020, 2, 10), people));
		rentablePlace.addNewRoom(room1);

		Room room2 = new Room("camera 2", 3, 25, 1);
		room2.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 1, 5), LocalDate.of(2020, 1, 5), people));
		room2.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 2, 5), LocalDate.of(2020, 2, 15), people));
		rentablePlace.addNewRoom(room2);

		Room room3 = new Room("camera 3", 4, 30, 1);
		room3.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 1, 5), LocalDate.of(2020, 1, 5), people));
		room3.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 2, 5), LocalDate.of(2020, 2, 15), people));
		rentablePlace.addNewRoom(room3);

		Room room4 = new Room("camera 4", 5, 30, 2);
		room4.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 1, 5), LocalDate.of(2020, 1, 5), people));
		room4.addActiveBooking(new Booking(null, null, LocalDate.of(2020, 5, 5), LocalDate.of(2020, 6, 15), people));
