...
public class BookHotelController {
	...
	/**
	 * Constructor of the class. Creates all the rentable place contained in
	 * database.
	 */
	 ...
	 * @param rentPlace
	 */
	public void createBooking(CityDateBean fields, List<Person> people, List<RoomBean> roomBeans,
			RentablePlace rentPlace) {

		Booking booking = BookingFactory.getInstance().createBooking(rentPlace.getName(),
